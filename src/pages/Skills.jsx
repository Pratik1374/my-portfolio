...
//             <span className="w-full h-2 bg-white rounded-md inline-flex mt-2">
//               <motion.span
//                 initial={{ x: "-100%", opacity: 0 }}
//                 animate={{ x: 0, opacity: 1 }}
//                 transition={{ duration: 0.5, delay: 0.5 }}
//                 className="w-[85%] h-full bg-gradient-to-r from-blue-600 via-blue-400 to-blue-200 rounded-md relative"
//               >
...
//                 animate={{ x: 0, opacity: 1 }}
//                 transition={{ duration: 0.5, delay: 0.5 }}
//                 className="w-[75%] h-full bg-gradient-to-r from-blue-600 via-blue-400 to-blue-200 rounded-md relative"
//               >
...
//                 animate={{ x: 0, opacity: 1 }}
//                 transition={{ duration: 0.5, delay: 0.5 }}
//                 className="w-[65%] h-full bg-gradient-to-r from-blue-600 via-blue-400 to-blue-200 rounded-md relative"
//               >
...
//                 animate={{ x: 0, opacity: 1 }}
//                 transition={{ duration: 0.5, delay: 0.5 }}
//                 className="w-[80%] h-full bg-gradient-to-r from-blue-600 via-blue-400 to-blue-200 rounded-md relative"
//               >
...
//                 animate={{ x: 0, opacity: 1 }}
//                 transition={{ duration: 0.5, delay: 0.5 }}
//                 className="w-[90%] h-full bg-gradient-to-r from-blue-600 via-blue-400 to-blue-200 rounded-md relative"
//               >
...
//                 animate={{ x: 0, opacity: 1 }}
//                 transition={{ duration: 0.5, delay: 0.5 }}
//                 className="w-[70%] h-full bg-gradient-to-r from-blue-600 via-blue-400 to-blue-200 rounded-md relative"
//               >
...
const ProgressBar = ({ percentage }) => {
  ...
  useEffect(() => {
    const observer = new IntersectionObserver(
      ...
      {
        threshold: 0.1, // Set the threshold to a value that suits your needs
      }
    );
