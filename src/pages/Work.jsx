          ...
          <div className="flex flex-wrap">
            <div className="mx-2 flex flex-wrap justify-center mt-3">
              {myWork.map((work, index) => (
                ...
                target="_blank"
                rel="noopener noreferrer" className="flex bg-cyan-400 justify-center items-center rounded-full p-1">
                        <img
                          src={github}
                          alt=""
                      ...
                      {work.liveLink && (
                      <div className="flex bg-cyan-400 justify-center items-center rounded-full p-1">
                        <img
                          src={live}
                          alt=""
                          className="h-[20px] w-[20px] object-fill "
                  ...
                  >
                    ...
                    <div className="mx-3 my-bg-black-gradient p-2 mt-2 rounded-md">
                      {work.description.split("\n").map((line, ind) => (
                        <p key={ind} className="text-blue-100">{line}</p>
                      ))}
                    </div>
                  </div>
                </ReactCardFlip>
